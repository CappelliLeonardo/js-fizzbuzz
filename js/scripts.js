...
// BONUS 2:
// Applica stili differenti agli elementi aggiunti al DOM nel BONUS 1, a seconda che il valore inserito
// sia un numero, un fizz, un buzz o un fizzbuzz.
// Se sei a corto di idee per lo stile, potresti
...
for (let number = 1; number <= 100; number++) {
    ...
    if ( number % 3 == 0 && number % 5 == 0) {
        ...
        numDaStampare = number
    }


    
    document.getElementById("elements").innerHTML += (numDaStampare);  
